...
const CHECK_JOBS: CheckJob[] = [
  { label: '07:00 Economic Daily Scraper｜爬取經濟日報（早）', workflowName: 'Economic Daily Scraper', twHour: 7, twMinute: 0 },
  { label: '16:00 Active ETF Holdings Update (Daily)｜更新主動型 ETF 持股（第一次）', workflowName: 'Active ETF Holdings Update (Daily)', twHour: 16, twMinute: 0 },
  { label: '18:30 Daily Update｜每日更新（市值 + 三大法人）', workflowName: 'Daily Update', twHour: 18, twMinute: 30 },
  { label: '19:00 MOPS Scraper｜爬取公開資訊觀測站重訊', workflowName: 'MOPS Scraper', twHour: 19, twMinute: 0 },
  { label: '19:30 Active ETF Holdings Update (Daily)｜更新主動型 ETF 持股（第二次）', workflowName: 'Active ETF Holdings Update (Daily)', twHour: 19, twMinute: 30 },
  { label: '21:30 Economic Daily Scraper｜爬取經濟日報（晚）', workflowName: 'Economic Daily Scraper', twHour: 21, twMinute: 30 },
  { label: '18:35 Market Sentiment Update｜更新市場情緒指標（第一次）', workflowName: 'Market Sentiment Update', twHour: 18, twMinute: 35, days: [1, 2, 3, 4, 5] },
  { label: '21:00 Market Sentiment Update｜更新市場情緒指標（備援）', workflowName: 'Market Sentiment Update', twHour: 21, twMinute: 0, days: [1, 2, 3, 4, 5] },
  { label: '20:00 Generate Chip Topic｜生成籌碼題材標籤', workflowName: 'Generate Chip Topic', twHour: 20, twMinute: 0, days: [1, 2, 3, 4, 5] },
  { label: '21:30 Margin Trading Update｜更新融資融券數據', workflowName: 'Margin Trading Update', twHour: 21, twMinute: 30, days: [1, 2, 3, 4, 5] },
  { label: '週六 08:00 ETF Holdings Update (Weekly)｜每週 ETF 持股更新', workflowName: 'ETF Holdings Update (Weekly)', twHour: 8, twMinute: 0, days: [6] },
  { label: '週六 09:00 Weekly Shareholder Update (Saturday)｜每週股東結構更新', workflowName: 'Weekly Shareholder Update (Saturday)', twHour: 9, twMinute: 0, days: [6] },
  { label: '週六 11:00 Weekly Dividend Update (Saturday)｜每週股利資料更新', workflowName: 'Weekly Dividend Update (Saturday)', twHour: 11, twMinute: 0, days: [6] },
  { label: '週日 09:00 Weekly Full Update (Sunday)｜每週完整財務更新（台股）', workflowName: 'Weekly Full Update (Sunday)', twHour: 9, twMinute: 0, days: [0] },
  { label: '週日 10:00 Update US Financials｜更新美股財務資料', workflowName: 'Update US Financials', twHour: 10, twMinute: 0, days: [0] },
  { label: '週日 11:00 Weekly Balance Sheet Update (Monday)｜每週資產負債表更新', workflowName: 'Weekly Balance Sheet Update (Monday)', twHour: 11, twMinute: 0, days: [0] },
  { label: '週一 03:00 Cleanup old workflow runs｜清理舊 workflow 記錄', workflowName: 'Cleanup old workflow runs', twHour: 3, twMinute: 0, days: [1] },
];
