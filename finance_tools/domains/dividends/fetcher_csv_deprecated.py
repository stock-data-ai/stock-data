...
class DividendsFromCSVFetcher:
    ...
    def __init__(self, finance_tools_dir: str = 'finance_tools'):
        ...
        self.dividend_files = [
            {'path': os.path.join(self.finance_tools_dir, 'assets', 'dividend_csv', 'StockList整年_現金股利.csv'), 'type': 'cash'},
            {'path': os.path.join(self.finance_tools_dir, 'assets', 'dividend_csv', 'StockList整年_股票股利.csv'), 'type': 'stock'},
            {'path': os.path.join(self.finance_tools_dir, 'assets', 'dividend_csv', 'StockList半年_現金股利.csv'), 'type': 'cash'},
            {'path': os.path.join(self.finance_tools_dir, 'assets', 'dividend_csv', 'StockList半年_股票股利.csv'), 'type': 'stock'},
            {'path': os.path.join(self.finance_tools_dir, 'assets', 'dividend_csv', 'StockList逐季_現金股利.csv'), 'type': 'cash'},
            {'path': os.path.join(self.finance_tools_dir, 'assets', 'dividend_csv', 'StockList逐季_股票股利.csv'), 'type': 'stock'},
        ]
